        ...
        <div className="cursor-pointer bg-sky-600 h-screen-50 lg:h-20rem xxl:h-25rem flex items-center justify-center">
          <div className="capitalize text-center text-gray-100 font-light">
            ...
            <div>
              <a
                href="#"
                className="trasn-button border-gray-100 border-2 mt-5 inline-block px-8 rounded py-1 text-base hover:text-theme-skyblue hover:bg-white hover:border-white transition ease-linear duration-200 hover:font-medium"
              >
                Explore Parts
              </a>
            </div>
