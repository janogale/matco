              ...
              <div className="flex items-center justify-center w-full h-58 lg:w-1/3">
                <div className="flex items-center justify-center -mx-4 lg:pl-8">
                  <div className="flex flex-col items-end px-3">
                    <img
                      className="object-contain  rounded shadow-lg h-28 sm:h-48 xl:h-40 w-32 sm:w-64 xl:w-96"
                      src="/images/models/celerio/1.png"
                      alt=""
                    />
                    <img
                      className="object-contain w-40 h-40 rounded shadow-lg sm:h-32 xl:h-40 sm:w-64 xl:w-96"
                  ...
                  <div className="px-3">
                    <img
                      className="object-contain w-58 h-48 rounded shadow-lg sm:h-64 xl:h-92 sm:w-64 xl:w-96"
            ...
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
              <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
                  <span className="relative inline-block"></span> OUTSIDE CAR
                </h2>
